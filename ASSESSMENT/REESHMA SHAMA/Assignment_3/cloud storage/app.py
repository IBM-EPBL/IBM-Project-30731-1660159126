...
COS_API_KEY_ID="QwTafa5iixHovbVtUjFcCJ8xJrJ__ToZtWHzMNGhuXVl"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/e15a8c6f046e4fecb4d274d26941f0d2:c5a54c1a-e57d-4b92-bae7-dd9dda74906f::"
...
@app.route('/')
def index():
    files = get_bucket_contents('reeshma')
