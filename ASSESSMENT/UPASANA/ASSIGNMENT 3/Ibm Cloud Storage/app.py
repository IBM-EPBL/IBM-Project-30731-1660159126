...
COS_API_KEY_ID="BkhxlMLy7lRcRKTF_Tst-pivWGUYhj5XfDG2oQQW2CxS"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/0f00bf9a1fed47a08440571af99a57ab:39465ae2-7f5a-4571-9a41-98117a83dd76::"
...
@app.route('/')
def index():
    files = get_bucket_contents('assignment3ibm')
