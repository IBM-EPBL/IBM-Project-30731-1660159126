...
COS_API_KEY_ID="qKhFFJkaNhcoE6i7Ghz4SPcI4EVapyg4BRtFSXaAGl7q"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/49a7c32e32a64fe687912c813828578d:08ca4d6e-3df3-4aa5-afd2-215c7b469dc3::"
...
@app.route('/')
def index():
    files = get_bucket_contents('imagespd')
