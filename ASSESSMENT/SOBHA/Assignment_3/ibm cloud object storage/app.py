...
COS_API_KEY_ID="uaM-iszvAQAPPvwKrJY4Sk8QBjR34chBs-yEfbErb_k-"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/7640ceba5236402fbdee7a7f604b8ed4:1515b1ac-eea7-4a22-bdac-aa12cb092f36::"
...
@app.route('/')
def index():
    files = get_bucket_contents('sobha')
